    ...
    <div className="min-h-screen bg-secondary flex items-center justify-center pt-20 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-12">
          <p className="text-[10px] font-black tracking-[0.8em] text-accent uppercase mb-4">BEGIN THE PROTOCOL</p>
          <h1 className="text-4xl text-luxury text-primary">ENROLL NOW.</h1>
        </div>
        <SignUp appearance={{
          elements: {
