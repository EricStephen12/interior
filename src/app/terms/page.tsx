    ...
    return (
        <div className="pt-24 sm:pt-40 pb-16 sm:pb-32 bg-white min-h-screen selection:bg-secondary">
            <div className="max-w-4xl mx-auto px-4 prose prose-slate prose-lg">
                ...
                <p className="text-text-muted font-light leading-relaxed mb-12 text-xl">Welcome to SHARERS GYM. By using our facility and website, you agree to these terms.</p>

                <h2 className="text-2xl font-bold text-primary mt-16 mb-6 uppercase tracking-widest border-l-4 border-accent pl-6">1. Membership & Access</h2>
                <p className="text-text-muted font-light leading-relaxed">Access is granted via your digital member pass. You must scan your pass to enter the facility. Passes are personal and non-transferable.</p>
                ...
                <p className="text-text-muted font-light leading-relaxed">We maintain a high-performance environment. Any behavior that disrupts the training experience of other members may result in immediate suspension of membership.</p>
