    ...
    return (
        <div className="pt-24 sm:pt-40 pb-16 sm:pb-32 bg-white min-h-screen selection:bg-secondary">
            <div className="max-w-4xl mx-auto px-4 prose prose-slate prose-lg">
                ...
                <p className="text-text-muted font-light leading-relaxed">We guarantee that every essence and artifact sold is 100% laboratory-certified and sourced directly from the SHARERS production labs.</p>
                ...
                <p className="text-text-muted font-light leading-relaxed">Structural integrity claims are managed via the SHARERS Laboratory Registry. Our concierge will facilitate the molecular verification process.</p>
