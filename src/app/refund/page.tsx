    ...
    return (
        <div className="pt-24 sm:pt-40 pb-16 sm:pb-32 bg-white min-h-screen selection:bg-secondary">
            <div className="max-w-4xl mx-auto px-4 prose prose-slate prose-lg">
                ...
                <p className="text-text-muted font-light leading-relaxed mb-12 text-xl">We want you to be fully satisfied with your membership and gear. Please review our return and cancellation policy below.</p>
