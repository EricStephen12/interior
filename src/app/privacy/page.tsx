    ...
    return (
        <div className="pt-24 sm:pt-40 pb-16 sm:pb-32 bg-white min-h-screen selection:bg-secondary">
            <div className="max-w-4xl mx-auto px-4 prose prose-slate prose-lg">
                ...
                <p className="text-text-muted font-light leading-relaxed">We collect high-precision data including legal name, encrypted communication channels, and secure vault destinations to facilitate exclusive access to the EXRICX collection.</p>
                ...
                <p className="text-text-muted font-light leading-relaxed">Your data is utilized strictly for investment fulfillment, bespoke concierge support, and exclusive access to new essence launches within the EXRICX ecosystem.</p>
