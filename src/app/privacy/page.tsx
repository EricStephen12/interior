    ...
    return (
        <div className="pt-24 sm:pt-40 pb-16 sm:pb-32 bg-white min-h-screen selection:bg-secondary">
            <div className="max-w-4xl mx-auto px-4 prose prose-slate prose-lg">
                ...
                <p className="text-text-muted font-light leading-relaxed mb-12 text-xl">We respect your privacy. This policy outlines how we handle and protect your personal information.</p>
                ...
                <p className="text-text-muted font-light leading-relaxed">We collect essential information like your name, contact details, and payment history to manage your membership and provide a seamless training experience.</p>
